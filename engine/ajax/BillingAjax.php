...
if( file_exists( ENGINE_DIR . "/modules/billing/plugins/" . preg_replace ("/[^a-zA-Z0-9\s]/", "", trim( ucfirst( $Plugin ) ) ) . "/ajax.php" ) )
	include_once ENGINE_DIR . "/modules/billing/plugins/" . preg_replace ("/[^a-zA-Z0-9\s]/", "", trim( ucfirst( $Plugin ) ) ) . "/ajax.php";
else
